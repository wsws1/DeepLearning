...
# models save path
models_path = './models/inceptionMouble'
log_path = './log/inceptionMouble'
...
for epoch in range(epoch_num):
    ...
    print("test step ,", epoch, " loss is: ", test_loss,
          "test_correct is :", test_correct)
    print("test lr is ", optimizer.state_dict()['param_groups'][0]['lr'])
    final_correct += test_correct

writer.close()
print("final correct: ",final_correct/epoch_num)
