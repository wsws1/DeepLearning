...
workspace_dir = '../../data/lfwcrop_color/faces'
...
def get_gender_gict(label_path):
    ...
    return gender_dict
gender_dict = get_gender_gict('../../data/lfwcrop_color/')
...
if __name__ == '__main__':
    ...
    for e, epoch in enumerate(range(n_epoch)):
        for i, data in enumerate(dataloader):
            ...
            # label
            f_label = Variable(LongTensor(np.random.randint(0, 2, bs)))
            ...
            gen_labels = Variable(LongTensor(np.random.randint(0, 2, bs)))
            ...
            # pylab.show()
        G.eval()
        f_imgs_sample = (G(z_sample,gen_labels).data + 1) / 2.0
